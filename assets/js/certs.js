(() => {
  const track = document.querySelector(".certs-track");
  const items = [...document.querySelectorAll(".certs-item")];
  const lightbox = document.querySelector("#cert-view");
  ...
  document.querySelector(".certs-carousel .certs-arrow.is-prev")?.addEventListener("click", () => {
    track.scrollBy({ left: -step(), behavior: scrollMode });
  });

  document.querySelector(".certs-carousel .certs-arrow.is-next")?.addEventListener("click", () => {
    track.scrollBy({ left: step(), behavior: scrollMode });
  });
